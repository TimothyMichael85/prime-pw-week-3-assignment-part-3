...
for (let i=0; i < supplyChanges.length; i++) {
    //if count > 0 log 'added' num 'parts', else if count < 0 log 'added' num 'parts' else log 'no change'){
...
// I worked at this for over an hour and could not get it to work the way I wanted.
//let parts = 572
//let boxes = [];
//while (parts >=0) {
//parts/7 === boxes
